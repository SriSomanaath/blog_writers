          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                Training Contrastive Language Image Pretraining (CLIP) Model from Scratch: An Image Retrieval App
                </h2>
                ...
                <div>
                  ...
                  You may wonder why you need advanced architectures for classification when we have task-specific models like ResNet? These models, although highly accurate on 
                    <strong className="text-primary dark:text-white">
                    ImageNet1k or ImageNet21k 
                    </strong>
                    classes, struggle to generalize effectively for out of distribution classes. CLIP can overcome this limitation by creating a flexible set of image embeddings to detect any class from the input image by providing a set of labels.
                  </p>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text="Computer Vision" />
                        <TagButton text="Deep Learning" />
                        <TagButton text="NLP Similarity Measure	" />
                      </div>
                    </div>
                    <div className="mb-5">
