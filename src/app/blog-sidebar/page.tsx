                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text="Edge Devices " />
                        <TagButton text="3D Computer Vision" />
                        <TagButton text="Face Detection " />
                      </div>
                    </div>
                    <div className="mb-5">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-sm bg-white dark:shadow-none">
                ...
                <ul className="p-8">
                  <li className="mb-6 border-b border-body-color border-opacity-10 pb-6 dark:border-white dark:border-opacity-10">
                    <RelatedPost
                      title="Depth Anything: Accelerating Monocular Depth Perception"
                  ...
                  <li className="mb-6 border-b border-body-color border-opacity-10 pb-6 dark:border-white dark:border-opacity-10">
                    <RelatedPost
                      title="Understanding Visual SLAM for Robotics Perception: Building Monocular SLAM from Scratch in Python OpenCV"
